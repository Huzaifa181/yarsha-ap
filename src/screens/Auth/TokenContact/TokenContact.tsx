...
* @function @TokenContact
* @returns JSX.Element
**/

const TokenContact: FC<IProps> = (props) => {
    ...
    const route = useRoute<SafeScreenRouteProp & { params: { token: any } }>();
    ...
    }, [selectedUsers, navigation, token]);
...
export default React.memo(TokenContact);
